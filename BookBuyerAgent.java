...
public class BookBuyerAgent extends Agent {
	...
	protected void setup() {
		...
		if (args != null && args.length > 0) {
			...
			System.out.println("No target memory specified");
			doDelete();
		}
	}
			...
			case 3:      
				...
				if (reply != null) {
					...
					if (reply.getPerformative() == ACLMessage.INFORM) {
						...
						System.out.println(targetBookTitle+" memory successfully purchased from agent "+reply.getSender().getName());
						System.out.println("Price = "+bestPrice);
						myAgent.doDelete();
					}
					else {
						System.out.println("Attempt failed: requested memory already sold.");
					}
